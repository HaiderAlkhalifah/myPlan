...
export default function Termsq() {
  return (
    <div className="container bg-white shadow-soft-card m-1 py-4  h-auto rounded-xl items-start justify-items-center">
      ...
      <div className="p-2  grid grid-cols-2 justify-items-center items-center  ">
        <div className="container shadow-soft-inner px-2 py-2  bg-greyb w-[120px] h-[500px] rounded-xl content-center">
          <MajorCard />
          <MajorCard />
          <MajorCard />
          <MajorCard />
        ...
        <div className="container shadow-soft-inner  bg-greyb w-[120px] h-[500px] rounded-xl content-center"></div>
      </div>
      <div className="grid grid-cols-2 content-evenly">
